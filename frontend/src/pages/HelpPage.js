...
const HelpPage = () => {
  useEffect(() => { document.title = "Help • JobFlowAI"; }, []);
  ...
  const faqGroups = {
    ...
    "Privacy & Data": [
      ...
      { q: "How do I delete my data?",
        a: "Go to My Resumes → select a document → Delete. For full account deletion, email support@jobflowai.app." },
    ],
    ...
    <div className="h-page">
      ...
      <header className="h-hero">
        <div className="h-hero-inner">
          ...
          <p className="h-subtitle">Quick guides, FAQs, and troubleshooting tips for JobFlowAI.</p>
        ...
        <section id="troubleshoot" className="h-grid-2">
          ...
          <div id="contact" className="h-card h-contact">
            ...
            <ul className="h-contact-list">
              <li>📧 <a className="h-link" href="mailto:support@jobflowai.app">support@jobflowai.app</a></li>
              <li>🐞 Report a bug from inside the app</li>
              <li>📚 Career Blog tips (coming soon)</li>
            </ul>
            <a className="btn btn-primary" href="mailto:support@jobflowai.app">
