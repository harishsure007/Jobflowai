      ...
      <header style={styles.header}>
        <div style={styles.headerInner}>
          <div style={styles.brandRow}>
            ...
            <span style={styles.brand}>JobFlowAI</span>
          </div>
          ...
          <div className="navWrap" style={styles.navWrap}>
            <nav aria-label="Primary" style={styles.nav}>
              <Dropdown
                label="Resume"
                items={["Upload Resume", "AI Parser", "Compare Versions"]}
                handlers={[
                  () => alert("Upload Resume coming soon!"),
                  () => alert("AI Parser coming soon!"),
                  () => alert("Compare Versions coming soon!"),
                ]}
                isOpen={open === "resume"}
              ...
              <Dropdown
                label="Cover Letter"
                items={["Generate", "Templates", "Tips"]}
                handlers={[
                  () => alert("Generate coming soon!"),
              ...
              <Dropdown
                label="Career Blog"
                items={["Articles", "Interview Tips", "Success Stories"]}
                handlers={[
                  () => alert("Articles coming soon!"),
                  () => alert("Interview Tips coming soon!"),
                  () => alert("Success Stories coming soon!"),
                ]}
                isOpen={open === "blog"}
                toggle={() => toggle("blog")}
                ref={refs.blog}
      ...
      <footer style={styles.footer}>
        <div style={styles.footerColWrap}>
          <div style={styles.footerCol}>
            <h4 style={styles.footerHead}>JobFlowAI</h4>
        ...
        <div style={styles.footerBottom}>
          <span>© {new Date().getFullYear()} JobFlowAI. All rights reserved.</span>
        </div>
      </footer>
    </div>
  );
