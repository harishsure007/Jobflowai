...
import { apiRequest, BASE as API_BASE } from "../api/client";
        ...
        {step === 1 && (
          <>
            ...
            <div style={sx.footerRow}>
              <span style={sx.hint}>
                API base: <code style={sx.code}>{API_BASE}</code>
              </span>
            </div>
          </>
        )}
...
const sx = {
  ...
  btnPrimary: {
    ...
    fontWeight: 900,
    letterSpacing: ".2px",
    background: "linear-gradient(180deg,#2aa5ff 0%, #1998f7 100%)",
    color: "#0b1722",
    boxShadow: "0 12px 30px rgba(42,165,255,.28), inset 0 1px 0 rgba(255,255,255,.35)",
  ...
  code: { background: "#13293d", color: "#eaf4ff", padding: "2px 6px", borderRadius: 6, fontSize: 12 },

  // OTP row (fixed-size boxes, centered)
  otpWrap: {
    display: "flex",
